(custom-set-variables
 ...
 '(package-selected-packages
   '(diminish meow d-mode undo-tree latex-preview-pane cider exec-path-from-shell cmake-mode eshell-vterm vterm neotree simple-modeline vertico use-package markdown-mode magit lua-mode go-mode flycheck fennel-mode elpy elfeed eglot auctex))
