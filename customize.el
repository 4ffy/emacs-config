(custom-set-variables
 ...
 '(package-selected-packages
   '(exec-path-from-shell restart-emacs cmake-mode json-mode yaml-mode eshell-vterm vterm neotree simple-modeline vertico use-package rust-mode markdown-mode magit lua-mode go-mode flycheck fennel-mode elpy elfeed eglot auctex))
