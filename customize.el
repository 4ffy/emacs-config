(custom-set-variables
 ...
 '(package-selected-packages
   '(auctex avy company consult devil diminish dmenu editorconfig eglot elfeed elisp-autofmt emacs-everywhere engrave-faces erc-hl-nicks eshell-vterm ess exec-path-from-shell exwm fennel-mode flycheck flycheck-eglot go-mode json-mode keepass-mode link-hint lua-mode magit marginalia markdown-mode orderless org-roam paredit pyvenv racket-mode rust-mode simple-modeline slime titlecase vertico visual-fill-column vterm wgrep yaml-mode yasnippet yasnippet-snippets))
