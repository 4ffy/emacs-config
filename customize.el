(custom-set-variables
 ...
 '(package-selected-packages
   '(paredit titlecase erc-hl-nicks ef-themes modus-themes json-mode js2-mode company yasnippet-snippets yasnippet yaml-mode keepass-mode cuda-mode ess orderless org-roam esup use-package magit avy clojure-mode marginalia racket-mode rust-mode dmenu exwm link-hint diminish meow d-mode undo-tree cider exec-path-from-shell cmake-mode eshell-vterm vterm neotree simple-modeline vertico markdown-mode lua-mode go-mode flycheck fennel-mode elpy elfeed eglot auctex))
