(custom-set-variables
 ...
 '(package-selected-packages
   '(diminish undo-tree latex-preview-pane cider exec-path-from-shell restart-emacs cmake-mode json-mode eshell-vterm vterm neotree simple-modeline vertico use-package markdown-mode magit lua-mode go-mode flycheck fennel-mode elpy elfeed eglot auctex))
